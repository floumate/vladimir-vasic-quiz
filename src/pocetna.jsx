      ...
      <main className="app__main">
        <div className="container">
          ...
          <section className="landing-hero landing-narrow text-center fade-in">
            <span className="eyebrow">Finansijska dijagnoza za vlasnike firmi</span>
            <h1 className="mt-16">Vaša firma radi. Novac ipak nestaje.</h1>
          ...
          <section className="landing-section landing-narrow text-center">
            <h2>Dve minuta do jasne slike o firmi</h2>
